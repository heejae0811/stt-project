...
# 텍스트 분석 함수
def top_words_by_preference(df, text_columns, label_col='preferred_same_mode', top_n=20):
    results = []
...
# 엑셀 저장
top_words_df.to_excel('./results/preferred_same_mode_results.xlsx', index=False)
